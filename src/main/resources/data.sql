...
INSERT INTO `biblioteca`.`categorias` (`nombre`, `descripcion`) VALUES ('Autobiografía', 'vidas relatadas por el autor');
...
INSERT INTO `biblioteca`.`autores` (`apellido`, `biografia`, `fecha_nacimiento`, `nacionalidad`, `nombre`) VALUES ('Añon', 'Autora de libros estilo escape room', '1995-01-16', 'España', 'Mari');
...
INSERT INTO biblioteca.libros (titulo, numero_paginas, disponible, id_autor, id_categoria) VALUES ('La Odisea', 416, true, 10, 6);
INSERT INTO biblioteca.libros (titulo, numero_paginas, disponible, id_autor, id_categoria) VALUES ('Don Quijote de la Mancha', 864, true, 11, 4);
